...
<div class="container-xxl py-10 mt-5 ok">
    ...
    <div class="payment_container_step1">
        ...
        <div style="width:90%; max-height:300px; overflow-y: scroll; overflow-x: hidden;">
			...
			<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
				...
				<div class="row text-center col-lg-5 col-md-12 wow fadeInUp" data-wow-delay="0.5s" style="width: 55%; float: none; margin: 0 auto">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="row">
												<div class="col-lg-8">
													<input type="text" id="deli_address" name="deli_address" value=""  class="form-control" placeholder="배송지명 ex:집 또는 회사 등" >
												</div>
											</div>
									</tr>
									<tr>
										...
										<td>	
											<div class="row">
												...
												<div class="col-lg-6">
													<input type="text" id="deli_name" name="deli_name" value="<%=name %>" style="background-color:transparent; border:none;" class="form-control" readonly>
												</div>
												
												<div class="col-lg-3">
													<button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#namemodify">수정</button>
												</div>
											
										<!-- Modal -->
										<div class="modal fade" id="namemodify" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										    ...
										    <div class="modal-content">
										      ...
										      <div class="modal-body">
										        <div class="row">
										        	...
										        	<div class="col-lg-6">
														<input type="text" id="newdeli_name" placeholder="한글 사용 2~10자." class="form-control">
													</div>
										      ...
										      <div class="modal-footer d-flex justify-content-center">
        										...
        										<button type="button" id="modifyname"  data-bs-dismiss="modal" class="btn btn-primary">수정하기</button>
      										</div>
										    </div>
										  </div>
										</div>
										...
										<td>
											<div class="row">
												...
												<div class="col-lg-6 pt-2">
													<input type="text" id="sangse_juso1" name="sangse_juso1" value="<%=sangse_juso1%>" readonly="" class="form-control">
												</div>
												<div class="col-lg-6 pt-2">
													<input type="text" id="sangse_juso2" name="sangse_juso2" value="<%=sangse_juso2%>" class="form-control">
												</div>
					...
					<div class="row pt-3 ">
						...
						<div class="col-5 ">
						 <button id="return" onclick="location.href='/book-store'" class="btn border w-100 py-3">돌아가기</button>
						</div>
					</div>
				</div>
			</div>
