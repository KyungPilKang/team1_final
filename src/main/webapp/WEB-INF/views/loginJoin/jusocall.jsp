...
<form name="form" id="form" method="post">
	...
	<div><input type="text"  style="width:500px;" id="jibunAddr"  name="zipNo" /></div>
	<div><input type="text"  style="width:500px;" id="roadAddrPart1"  name="roadAddrPart1" /></div>
	<div><input type="text"  style="width:500px;" id="addrDetail"  name="addrDetail" /></div>
