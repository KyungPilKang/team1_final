        ...
        <div class="default">
            <div class="subnavbar">
                <div class="navbar-main">
                    <div class="navbar-name">- 요청 목록 -</div>
                </div>
                <div class="navbar-bt">
                    <div>
            ...
            <div class="default-intro request-main">
                <div class="intro move-list">
                    <h1 class="move-list_subject">- 요청 목록 -</h1>
                    <div class="make-movelist">
                        <div class="move review-list">
                            <ul>
                                ...
                                <li>게시일<input type="text" placeholder="입력하세요!" style="height: 40px; width: 150px;"></li>
                            </ul>
                            <ul>
                                <li>이름<input type="text" placeholder="입력하세요!" style="height: 40px; width: 150px;"></li>
                                <li>과목<input type="text" placeholder="입력하세요!" style="height: 40px; width: 150px;"></li>
                ...
                <div class="qna-bt request-bt">삭제</div>
            </div>
        </div>
    </div>
</div>
