    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <h1 class="display-3 text-white animated slideInDown">강의 영상</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row gy-5 gx-4">
            ...
            <div class="col-lg-4">
                <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">
                        <i class="fa-solid fa-user text-primary me-2"></i>강사 정보
                    </h3>
                    <p>
                ...
                <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                    ...
                    <button class="btn btn-primary w-100">강의자료 확인</button>
                    <br> <br>
                    <button class="btn btn-primary w-100">PDF 확인</button>
                </div>
            </div>
        </div>
    </div>
