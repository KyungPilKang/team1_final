...
<jsp:include page="/WEB-INF/views/bookstore/header.jsp"/>
	...
	<div class="container-xxl py-5">
		<form action="studyregcnf" method="post">
			<div class="container">
					...
					<div class="row text-center col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s" style="width: 40%; float: none; margin: 0 auto;">
						<div class="row g-3">
							<div class="col-12">
								<div class="form-floating">
									<h3>시작날짜</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_fdate }" readOnly>
								</div>
								<br> <br>
								<div class="form-floating">
									<h3>마무리날짜</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_edate }" readOnly>
								</div>
								<br> <br>
								<div class="form-floating">
									<h3>시작시간</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_ftime }" readOnly>
								</div>
								<br> <br>
								<div class="form-floating">
									<h3>마무리시간</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_etime }" readOnly>
								</div>
								<br> <br>
							</div>
						</div>
					...
					<div class="row text-center col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s" style="width: 30%; float: none; margin: 0 auto;">
						<div class="row g-3">
							<div class="col-12">
								<div class="form-floating">
									<h3>스터디 제목</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_title }" readOnly>
								</div>
								<br> <br>
								<div class="form-floating">
									<h3>오픈링크주소</h3>
									<input style="background: rgba(6, 187, 204, 0.3); font-size: 2.0em" type="text" class="form-control text-center" value="${regstudy.study_kakao }" readOnly>
								</div>
								<br> <br>
								<div class="form-floating">
									<h3>상세내용</h3>
									<textarea style="background: rgba(6, 187, 204, 0.3); height: 200px; font-size: 2.0em" class="form-control text-center" readOnly>${regstudy.study_contents }</textarea>
								</div>
								<br> <br>
							</div>
						</div>
