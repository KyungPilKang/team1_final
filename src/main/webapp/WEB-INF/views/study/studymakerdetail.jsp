...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/freelance/lib/owlcarousel/assets/owl.carousel.min.css"
          rel="stylesheet">
        ...
        <div class="row gy-6 gx-6">
            <div class="col-lg-12">
                ...
                <div class="mb-5">
                    ...
                    <p><i class="fa fa-angle-right text-primary me-2"></i>스터디기간 : ${studyPosted.study_fdate}
                        ~ ${studyPosted.study_edate}</p>
                    <p><i class="fa fa-angle-right text-primary me-2"></i>스터디시간 : ${studyPosted.study_ftime}
                        ~ ${studyPosted.study_etime}</p>
...
<div id="contents_footer" class="parent" style="margin-bottom:150px;">
    <div class="row text-center col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.3s"
         style="width: 20%; margin-left:200px; ">
        <div class="row g-3">
            <div class="col-12">
                <div class="col-12 mt-4">
                    <button id="canclebtn" class="btn btn-outline-primary w-35 py-3"
                            onclick="window.location='/studymakermain'">목록 으로
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="row text-center col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.3s" style="width: 20%;   ">
        <div class="row g-3">
            <div class="col-12">
                <div class="col-12 mt-4">
                    <form id="delForm" action="/deletestudy" method="post">
                        <input name="study_no" id="study_no" type="hidden" value='${studyPosted.study_no}'>
                    </form>
                    <button id="delStudy" class="btn btn-outline-primary w-35 py-3" onclick="delStudy()">삭제 하기</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="col-12 mt-4">
                    <c:if test="${not empty studentList }">
                        <select id="attendList" class="btn btn-outline-primary w-35 py-3"
                ...
                <div class="col-12 mt-4">
                    ...
                    <select id="attendResult" class="btn btn-outline-primary w-35 py-3"
                            style="float:left; height:70px;">
                        <c:choose>
