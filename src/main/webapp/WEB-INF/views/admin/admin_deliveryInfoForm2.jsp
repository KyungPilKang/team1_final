    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row justify-content-center py-5">
                ...
                <span class="col-lg-2 col-md-3 text-center text-primary py-3"><i class="fa fa-2x fa-clock text-secondary me-2"></i>상품준비중 ▶</span>
            ...
            <div class="row g-1 justify-content-center py-5">
                <span class="col-lg-1 col-md-3">
                    <button class="btn btn-primary w-100 py-1" type="submit" href="http://localhost:8090/deliveryinfo1">이전</button>
                </span>
                <span class="col-lg-1 col-md-3">
                    <button class="btn btn-primary w-100 py-1" type="submit" href="http://localhost:8090/deliveryedite">다음</button>
                </span>
                <span class="col-lg-1 col-md-3">
