    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row justify-content-center py-5">
                ...
                <span class="col-lg-2 col-md-3 text-center text-primary py-3"><i class="fa fa-2x fa-home text-primary mb-2"></i>배송완료</span>
            </div>
            ...
            <div class="row g-1 justify-content-center py-5">
                <span class="col-lg-1 col-md-3">
                    <a class="btn btn-primary w-100 py-1" type="submit" href="http://localhost:8090/deliveryinfo4/${orderInfo.order_num}">이전</a>
                </span>
                <span class="col-lg-1 col-md-3">
                    <a class="btn btn-primary w-100 py-1" type="submit" href="http://localhost:8090/orderlist/orderlist?state=2">목록으로</a>
                </span>
            </div>
