...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- 상품 배송중 리스트 Start -->
        <div class="container-xxl py-5" id="prodDeli">
            <div class="container">
                <h1 class="text-center mb-4 wow fadeInUp" data-wow-delay="0.1s">상품 배송중 리스트</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0 active">
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="">상품 배송중</a>
                                        </div>
                                        <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>배송일 2021.06.03</small>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- 상품 배송완료 리스트 Start -->
        <div class="container-xxl py-5" id="deliCompl">
            <div class="container">
                <h1 class="text-center mb-4 wow fadeInUp" data-wow-delay="0.1s">상품 배송완료 리스트</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
